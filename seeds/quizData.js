  ...
  await knex('types').insert([
    {
      ...
      image:"http://localhost:8080/images/ISTJ.svg"      
    },
    {
      type: 'INFJ',
      type_name: 'COUNSELOR',
      ...
      career:JSON.stringify(["Dentist", "Certified public accountant", "Supply chain managers",  "Bank teller",  "Military officer",  "Inspector", "Lawyer", "Civil engineer", "Actuary", "Executive Consultant", "Financial analyst", "Actuary", "Bailiff",  "Investigator", "Forensic psychologist", "Secretary", "Judge", "Program administrator", "Executive assistant", "Support specialist", "Auditor", "Budget analyst", "Financial controller"]),
      image:"http://localhost:8080/images/INFJ.svg"      
    },
    {
      type: 'ISFJ',
      type_name: 'DEFENDER',
      ...
      image:"http://localhost:8080/images/ISFJ.svg"     
    },
    {
      type: 'INFP',
      type_name: 'HEALER',
      ...
      image:"http://localhost:8080/images/INFP.svg"     
    },
    {
      type: 'ENFJ',
      type_name: 'TEACHER',
      ...
      image:"http://localhost:8080/images/ENFJ.svg"     
    },
    {
      type: 'ENFP',
      type_name: 'CHAMPION',
      ...
      image:"http://localhost:8080/images/ENFP.svg"     
    },
    {
      type: "INTJ",
      ...
      image:"http://localhost:8080/images/INTJ.svg"      
    },
    {
      type: 'ENTJ',
      type_name: 'COMMANDER',
      ...
      image:"http://localhost:8080/images/ENTJ.svg"     
    },
    {
      type: "ENTP",
      type_name: 'VISIONARY',
      ...
      image:"http://localhost:8080/images/ENTP.svg"      
    },
    {
      type: "INTP",
      type_name: 'ARCHITECT',
      ...
      image:"http://localhost:8080/images/INTP.svg"      
    },
    {
      type: "ESFJ",
      type_name: 'PROVIDER',
      ...
      image:"http://localhost:8080/images/ESFJ.svg"     
    },
    {
      type:"ESFP",
      type_name: 'PERFORMER',
      ...
      career:JSON.stringify(["Accountant", "Advertising sales", "Event planner", "Guidance counselor", "Curator","Nurse", "Nutritionist", "Office manager", "Optometrist", "Physician", "Psychologist", "Receptionist", "Social worker", "Technical support specialist"]),
      image:"http://localhost:8080/images/ESFP.svg"
    },
    {
      type:"ISFP",
      type_name: 'COMPOSER',
      ...
      image:"http://localhost:8080/images/ISFP.svg"
    },
    {
      type:"ESTJ",
      ...
      image:"http://localhost:8080/images/ESTJ.svg"
    },
    {
      type:"ESTP",
      type_name: 'DYNAMO',
      ...
      image:"http://localhost:8080/images/ESTP.svg"
    },
    {
      type:"ISTP",
      type_name: 'CRAFTSMAN',
      ...
      career:JSON.stringify(["Actor", "Entrepreneur", "Marketer", "Paramedic", "Stockbroker", "Creative director", "Project manager", "Chief financial officer", "Financial planner", "Architect", "Paramedic", "Financial Planner", "Vocational Teacher"]),
      image:"http://localhost:8080/images/ISTP.svg"
    }  
  ]);
};
